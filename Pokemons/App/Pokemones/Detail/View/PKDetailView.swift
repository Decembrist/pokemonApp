...
//MARK: - Constraint
private extension PKDetailView {
    func addConstraint() {
...
//MARK: - Set Up View
private extension PKDetailView {
    func setUpView(model: PokemonModel) {
        ...
        statisticView = PKStatisticBlockView(model: model)
...
//MARK: other func
private extension PKDetailView {
    func createTypeButton(_ title: String, bgColor: UIColor) -> UIButton {
